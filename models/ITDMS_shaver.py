...
class MyModel(ContinualModel):
    ...
    def __init__(self, backbone, loss, args, transform):
        ...
        self.main_buffer = Buffer(int(self.args.buffer_size * self.args.main_batch))
    ...
    def observe(self, inputs, labels, not_aug_inputs, epoch=None):
        ...
        self.main_buffer.add_data(examples=not_aug_inputs, labels=labels, logits=outputs.detach())
    ...
    def sample_from_dataloader(self, data, sample_ratio, show_info=False, max_steps=MAX_STEPS, init_method="constant"):
        ...
        for step in range(max_steps):
            ...
            if show_info and step % 10 == 0:
                ...
                if l1_regularization.item() >= int(
                        sample_num / self.amplify_ratio) and l1_regularization.item() <= sample_num and abs(self.discrepancy_rate - (1 - sample_ratio) * 100) < 0.5 or step == max_steps or self.discrepancy_rate > self.stop_sample or self.discrepancy_rate >= (1 - sample_ratio) * 100:
