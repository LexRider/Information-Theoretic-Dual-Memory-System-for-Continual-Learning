...
default_args = [
    '--model', 'my_model_new',  # Replace with your default model
    '--dataset', 'seq-mnist',  # Replace with your default dataset
    '--buffer_size', '500',  # Replace with your default buffer size
    '--lr', '0.03',
    '--minibatch_size', '10',
    '--alpha', '1.0',
    '--beta', '0.5',
...
# Insert default args at the beginning of sys.argv if it's empty
if len(sys.argv) == 1:
